...
namespace System.Collections.Generic
{
        ...
        IReadOnlyDictionary<TKey, TValue>
    {
        ...
        private void AddRange(IEnumerable<KeyValuePair<TKey, TValue>> enumerable)
        {
            ...
            if (enumerable.GetType() == typeof(PooledDictionary<TKey, TValue>))
            {
                PooledDictionary<TKey, TValue> source = (PooledDictionary<TKey, TValue>) enumerable;
        ...
        private int Initialize(int capacity)
        {
            ...
            int[] buckets = ArrayPool<int>.Shared.Rent(size);
            Entry[] entries = ArrayPool<Entry>.Shared.Rent(size);
...
#endif
            if (_buckets != null) ArrayPool<int>.Shared.Return(_buckets);
            if (_entries != null) ArrayPool<Entry>.Shared.Return(_entries);
            _buckets = buckets;
            _entries = entries;
        ...
        /// the additional overhead on each <see cref="PooledDictionary{TKey,TValue}"/> instantiation, especially in AOT scenarios.
        /// </summary>
        internal static class CollectionsMarshalHelper
        {
            /// <inheritdoc cref="CollectionsMarshal.GetValueRefOrAddDefault{TKey, TValue}(PooledDictionary{TKey,TValue}, TKey, out bool)"/>
            public static ref TValue? GetValueRefOrAddDefault(PooledDictionary<TKey, TValue> dictionary, TKey key,
                out bool exists)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            IEnumerator<TKey> IEnumerable<TKey>.GetEnumerator() =>
                Count == 0 ? SZGenericArrayEnumerator<TKey>.Empty : GetEnumerator();
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            IEnumerator<TValue> IEnumerable<TValue>.GetEnumerator() =>
                Count == 0 ? SZGenericArrayEnumerator<TValue>.Empty : GetEnumerator();
