...
namespace System
{
    ...
    internal static class ThrowHelper
    {
        ...
        {
            throw new ArgumentException("ArgumentException_DestinationTooShort");
        }

        [DoesNotReturn]
        internal static void ThrowArgumentException_OverlapAlignmentMismatch()
        {
            throw new ArgumentException("ThrowArgumentException_OverlapAlignmentMismatch");
        }

        [DoesNotReturn]
        internal static void ThrowArgumentException_ArgumentNull_TypedRefType()
        {
            throw new ArgumentNullException("value", "ThrowArgumentException_ArgumentNull_TypedRefType");
        }
        ...
        {
            throw new ArgumentException("ThrowArgumentException_TupleIncorrectType", "other");
        }
        ...
        {
            throw new ArgumentException("ThrowArgumentException_BadComparer");
        }
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(month), month, "ThrowArgumentOutOfRange_Month");
        }

        [DoesNotReturn]
        internal static void ThrowArgumentOutOfRange_DayNumber(int dayNumber)
        {
            throw new ArgumentOutOfRangeException(nameof(dayNumber), dayNumber, "ThrowArgumentOutOfRange_DayNumber");
        }

        [DoesNotReturn]
        internal static void ThrowArgumentOutOfRange_BadYearMonthDay()
        {
            throw new ArgumentOutOfRangeException(null, "ThrowArgumentOutOfRange_DayNumber");
        }

        [DoesNotReturn]
        internal static void ThrowArgumentOutOfRange_BadHourMinuteSecond()
        {
            throw new ArgumentOutOfRangeException(null, "ThrowArgumentOutOfRange_BadHourMinuteSecond");
        }

        [DoesNotReturn]
        internal static void ThrowArgumentOutOfRange_TimeSpanTooLong()
        {
            throw new ArgumentOutOfRangeException(null, "ThrowArgumentOutOfRange_TimeSpanTooLong");
        }
        ...
        [DoesNotReturn]
        internal static void ThrowAggregateException(PooledList<Exception> exceptions)
        {
